"""
Posterior Approximation Test: Strongly correlated features.
"""
import torch
...
def make_data(n_samples=1000, n_dims=20, noise_std=0.05, rho=0.99, seed=42):
...
def main():
    ...
    print("\n" + "=" * 70)
    print("POSTERIOR APPROX TEST: Strong Correlation")
    print("=" * 70)
