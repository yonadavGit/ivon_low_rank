"""
Posterior Approximation Test: Low-rank features with small full-rank noise.
"""
import torch
...
def make_data(n_samples=1000, n_dims=20, rank=5, noise_std=0.2, seed=42):
...
def main():
    ...
    print("\n" + "=" * 70)
    print("POSTERIOR APPROX TEST: Low-rank Features + Noise")
    print("=" * 70)
    print(f"\nDims: {n_dims}, noise_std: {noise_std}, weight_decay: {weight_decay}, rank: {rank}")

    x, y = make_data(n_samples=1000, n_dims=n_dims, rank=rank, noise_std=noise_std)
